...
<div id="main">
	<form action="<%=request.getContextPath()%>/MovementController?action=saveMovement" method="POST">
		<div class="container">
			<h3>Movement</h3>
			<label><b>Id</b></label>
			...
			<label><b>Quantity</b></label>
	   		<input type="number" onkeypress="return onlyNumberKey(event)" placeholder="Enter quantity" name="quantity" id="quantity" value="${mov.quantity}" required>
			<br>
